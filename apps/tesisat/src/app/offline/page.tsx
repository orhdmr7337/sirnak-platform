  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#050505] px-6">
      <div className="text-center">
        <div className="mx-auto mb-8 w-24 h-24 rounded-full bg-orange-500/10 flex items-center justify-center animate-pulse">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <button
            ...
            className="inline-flex items-center justify-center gap-2 bg-orange-500 px-6 py-3 font-semibold text-white rounded-lg hover:bg-orange-600 transition-colors"
          >
